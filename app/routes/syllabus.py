...
async def upload_syllabus(
    ...
    # ✅ ADDED: outer api timer wrapping the whole upload logic
    with timed("api.upload_syllabus.time"):
...
def delete_syllabus(
    ...
    # ✅ ADDED: outer api timer wrapping the whole delete logic
    with timed("api.delete_syllabus.time"):
